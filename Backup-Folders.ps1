...
<#
    .SYNOPSIS
    Provides folder based log management for application that do not transfer to long term storage.

    .DESCRIPTION
    This folder log management system is designed for applications that output logs into dated folders.  A
    collection of all folders will be taken and processed by folder name in format of 'yyyyMMdd'.  Each folder
    will be zipped and transfered to the destination location.

    .PARAMETER Source
    Root folder containing all of your dated folders.

    .PARAMETER Destination
    Destination location where you would all of your zip foldes to be located.
    ...
    .EXAMPLE
    PS> .\Backup-Folders.ps1 -Source 'C:\inetpub\wwwroot\FOLDER\Folder2\Processed' -Destination 'D:\Backups' -AppName 'Folder_Archive-Processed'
